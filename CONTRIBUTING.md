...
3. Run `yarn test` to validate you've got everything working
...
Please checkout [the issues](https://github.com/spirosikmd/open-source/issues)! Also, please watch the repo
